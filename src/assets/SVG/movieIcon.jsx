function movieIcon({setSearchQuery}){
    return(
        <>
        <div >
          <svg  onClick={()=>setSearchQuery("")} className="shadow-md mb-10 hover:scale-90 cursor-pointer duration-200 active:scale-120 active:rotate-360  shadow-amber-400 w-[100px] h-[100px] rounded-[600px]" xmlns="http://www.w3.org/2000/svg" width="120" height="110" viewBox="0 0 24 24">
            <g fill="none">
