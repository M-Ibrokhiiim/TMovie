function movieIcon({setSearchQuery}){
    return(
        <>
        <div >
          <svg  onClick={()=>setSearchQuery("")} className="shadow-md mb-10  hover:scale-120 cursor-pointer duration-200 active:scale-90 active:rotate-360  shadow-amber-400 sm:w-[100px]  xl:w-[80px] xl:h-[80px] w-[80px] sm:h-[100px] h-[80px] rounded-[600px]" xmlns="http://www.w3.org/2000/svg" width="120" height="110" viewBox="0 0 24 24">
            <g fill="none">
